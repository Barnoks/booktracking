              ...
              <div class="row gy-2 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="d-grid my-3">
                    <button class="btn btn-primary btn-lg" type="submit">{{ __('Sign in') }}</button>
                    <p class="m-0 text-secondary text-center">back to login page? <a href="{{ route('login')}}" class="link-primary text-decoration-none">back</a></p>
                  </div>
                  <a class="m-0 text-secondary text-center"> <a href="/" class="link-primary text-decoration-none">Back</a></p>
                </div>
                <div class="col-12">
                </div>
              </div>
